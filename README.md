...
We are looking to see how you approach a coding problem and the steps you take to get to the solution.
It is expected that the code you implement functions correctly, even if it does not meet all the requirements.
